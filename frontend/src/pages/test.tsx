        ...
        <div className='grid grid-rows-2'>
            ...
            <div className=' grid grid-cols-1 border border-black h-30 md:items-center md:px-6 '>
              ...
              <div className=' text-xs w-3/4'>
                <strong className='  p-3 font-bold whitespace-normal md:text-2xl'>How I Built a Lo-fi Music Web Player with AI-Generated Tracks<br/></strong>
                </div>
                <p className='p-3 text-sm md:text-base text-gray-200'>What I learned to start, stop, and continue doing as a founder.</p>
